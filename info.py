...
BOT_TOKEN = environ.get('BOT_TOKEN', '7761377924:AAEZyZYR9SDTL9flcFFXtIcAO6wPdGadmUM')
...
LOG_VR_CHANNEL = int(environ.get('LOG_VR_CHANNEL', '-1002377299378'))
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002136507285')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
SUPPORT_GROUP = int(environ.get('SUPPORT_GROUP', '-1002250737579'))
